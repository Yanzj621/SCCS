...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        # self.iRMB0 = iRMB(self.ft_chns[0], self.ft_chns[0])
        # self.iRMB1 = iRMB(self.ft_chns[1], self.ft_chns[1])
        # self.iRMB2 = iRMB(self.ft_chns[2], self.ft_chns[2])
        # self.iRMB3 = iRMB(self.ft_chns[3], self.ft_chns[3])
        # self.iRMB4 = iRMB(self.ft_chns[4], self.ft_chns[4])
...
class drop_Encoder(nn.Module):
    def __init__(self, params):
        super(drop_Encoder, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.n_class = self.params['class_num']
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        # self.iRMB5 = iRMB(self.ft_chns[3], self.ft_chns[3])
        # self.iRMB6 = iRMB(self.ft_chns[2], self.ft_chns[2])
        # self.iRMB7 = iRMB(self.ft_chns[1], self.ft_chns[1])
    ...
    def forward(self, feature):
        ...
        x_last = nn.Dropout2d(0.5)(x_last)
...
class drop_UNet_2d(nn.Module):
    def __init__(self, in_chns, class_num):
        super(drop_UNet_2d, self).__init__()
        ...
        self.encoder = drop_Encoder(params)
        self.decoder = Decoder(params)
        dim_in = 16
        feat_dim = 32
        self.projection_head = nn.Sequential(
