...
parser.add_argument('--root_path', type=str, default='/home/hyh/yzj/SCCS-yzj/SCCS/data_split/LA', help='Name of Experiment')
...
snapshot_path = "./model/SCCS/LA_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "./model/SCCS/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
...
def test_calculate_metric():
    ...
    # save_model_path = os.path.join(snapshot_path, '{}_best_model_v8.pth'.format(FLAGS.model))
    save_model_path = os.path.join(snapshot_path, '/home/hyh/yzj/SCCS-yzj/SCCS/models/LA/VNet_best_model.pth'.format(FLAGS.model))
