...
def consistency_loss(pred1, pred2, dim=(2,3,4)):
    sq_diff = torch.square(pred1 - pred2)
    consistency_loss = torch.mean(sq_diff, dim=dim)
    return torch.mean(consistency_loss)
