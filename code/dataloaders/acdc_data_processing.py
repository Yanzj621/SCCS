...
slice_num = 0
mask_path = sorted(glob.glob("/home/hyh/yzj/BCP-main/BCP/data_split/ACDC/image/slices/*.nii.gz"))
for case in mask_path:
    ...
    if os.path.exists(msk_path):
        ...
        for slice_ind in range(image.shape[0]):
            f = h5py.File(
                '/home/hyh/yzj/SCCS-main/SCCS/data_split/ACDC/data/{}_slice_{}.h5'.format(item, slice_ind), 'w')
            f.create_dataset(
